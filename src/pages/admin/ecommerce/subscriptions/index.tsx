...
const Subscriptions = () => {
  ...
  const headersData = ["id", "name", "category", "price", "instock", "status", "image", "actions"];
  const rowsData = [
    {
      id: "1",
        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden mt-4 pb-4">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div className="flex w-full:1/2 float-right justify-between">
              <Link to={"/admin/ecommerce/addsubscription"}>
                {" "}
                <button
                  type="button"
                ...
                <form className="flex items-center">
                  ...
                  <div className="relative w-full">
                    ...
                    <input
                      type="text"
                      id="simple-search"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-xs border-gray-300 text-gray-900 text-sm rounded-lg focus:border-primary-500 block w-md pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  dark:focus:border-primary-500"
                      placeholder="Search"
                      required
                    />
                  </div>
                    ...
                    return (
                      <tr className="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 ">
                        ...
                        <td className="px-4 py-3 xs:px-3 xs:py-1 font-normal text-sm	">
                          ...
                          <Link to={"/admin/ecommerce/editsubscription/1"}>
                            <button
                              type="button"
                          ...
                          <Link to="/admin/ecommerce/subscriptiondetails/1">
                            <button
                              type="button"
