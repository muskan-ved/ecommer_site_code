...
const AddCoupon = () => {
    ...
    const handleimagechange = (e: any) => {
        ...
        reader.onload = (e: any) => {
            setcouponimage(e.target.result);
        };
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="-mx-3 md:flex mb-6">
                                ...
                                <div className="md:w-1/2 px-3 mb-6 md:mb-0 mt-2">
                                    ...
                                    {couponimage ?
                                        <div className="flex flex-col items-center justify-center w-full h-28 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 mt-1">
                                            <div className="img_wrp ">
                                                <img className="object-cover h-20 w-20" src={couponimage} />
                                                <div onClick={resetprofilepic} className="absolute top-0 right-0 text-red-600	 "><RiCloseCircleFill /></div>
                                            </div></div> :
                                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-24.5 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 mt-2">
                                            ...
                                            <input id="dropzone-file" accept=".gif,.jpg,.jpeg,.png,.svg"  {...register("couponimage")} onChange={handleimagechange} type="file" className="hidden" />
                                        </label>
                                    }
                                </div>
                            </div>
